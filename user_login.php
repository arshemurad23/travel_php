...
if(isset($_POST['add'])){
  ...
  $que = "select * from user_signup  where username = '$uname' limit 1 ";
...
if($pass == $row['pasword']){
  ...
  $_SESSION['preferred_currency'] = $row['preferred_currency'];
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5  style="color: #fd7e14;" class="card-title text-center pb-0 fs-4">Login For User</h5>
                  ...
                  <form class="row g-3 needs-validation" method="post" novalidate>
                    ...
                    <div class="col-12">
                   <a href="froget_user_pass.php">forget password</a>
                    </div>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Don't have account? <a href="user_sigup.php">Create an account</a></p>
                    </div>


                                  </form>
<br>
                              <p>Longin for login admin  <a href="admin_login.php">Admin</a>  </p>
